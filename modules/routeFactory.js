...
function createRouter(config) {
  ...
  for (const name of Object.keys(methods)) {
    // TODO: Remove fallback as real handlers are added per method.
    router.post(`/${name}`, handlers[name] || ((req, res) => {
      sendNotImplemented(res, moduleTitle, name, basePath);
    }));
  }
...
module.exports = { createRouter, sendError, sendSuccess, sendConfirmation, sendNotImplemented, escapeHtml };
